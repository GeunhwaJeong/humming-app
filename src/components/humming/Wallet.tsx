    ...
    <View style={[a.gap_lg]}>
      ...
      {isEmpty ? (
        ...
        <View
          ...
          <Text style={[a.text_sm, t.atoms.text_contrast_medium]}>
            <Trans>
              A wallet was created for you the moment you signed up. Send funds
              to your address from an exchange or another wallet to subscribe,
              tip, and unlock posts.
            </Trans>
          </Text>
        </View>
      ) : (
